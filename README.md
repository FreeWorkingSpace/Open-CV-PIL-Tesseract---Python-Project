# Open-CV-PIL-Tesseract---Python-Project
...
![png](small_project.png) 
If I were to use the [images.zip](./readonly/images.zip) file and search for "Mark" I should see the following image (note that there are times when there are no faces on a page, but a word is found!):![png](large_project.png)
...
print('Results for Keyword - Christopher')
lookup_keyword('Christopher')
